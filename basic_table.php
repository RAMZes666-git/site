              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr>
					...
					<td><?php
						echo $array[0]['Кп_А2'] ?></td>
					<td><?php
						echo $array[0]['Кс_А1'] ?></td>
					<td><?php
						echo $array[0]['Кс_А2'] ?></td>
					<td><?php
						echo $array[0]['Смч_А1'] ?></td>
					<td><?php
						echo $array[0]['Смч_А2'] ?></td>
					<td><?php
						echo $array[0]['Кпх'] ?></td>
					<td><?php
						echo $array[0]['Кн'] ?></td>
                  ...
                  <tr>
					...
					<td><?php
						echo $array[1]['Кп_А2'] ?></td>
					<td><?php
						echo $array[1]['Кс_А1'] ?></td>
					<td><?php
						echo $array[1]['Кс_А2'] ?></td>
					<td><?php
						echo $array[1]['Смч_А1'] ?></td>
					<td><?php
						echo $array[1]['Смч_А2'] ?></td>
					<td><?php
						echo $array[1]['Кпх'] ?></td>
					<td><?php
						echo $array[1]['Кн'] ?></td>
                  ...
                  <tr>
					...
					<td><?php
						echo $array[2]['Кп_А2'] ?></td>
					<td><?php
						echo $array[2]['Кс_А1'] ?></td>
					<td><?php
						echo $array[2]['Кс_А2'] ?></td>
					<td><?php
						echo $array[2]['Смч_А1'] ?></td>
					<td><?php
						echo $array[2]['Смч_А2'] ?></td>
					<td><?php
						echo $array[2]['Кпх'] ?></td>
					<td><?php
						echo $array[2]['Кн'] ?></td>
