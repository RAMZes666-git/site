...
<section id="container">
      ...
      <ul class="sidebar-menu" id="nav-accordion">
        ...
        <li class="sub-menu">
          ...
          <ul class="sub">
            ...
            <li class="active"><a href="xchart.php">капитальный(суммарный)</a></li>
  ...
  <section id="main-content">
    <section class="wrapper">
      <div class="row mt">
        <div class="col-lg-12">
            <form role="form" class="form-horizontal style-form" action="xchart.php" method="post">

                <div class="form-group has-success">
                    <label class="col-lg-1 control-label">Введите N</label>
                    <div class="col-lg-10">
                        <input type="text" autocomplete="off"   size="10"   style="height:34px"  name="sum" required oninvalid="this.setCustomValidity('Введите число от 1 до 9')" oninput="this.setCustomValidity('')"  pattern="[1-9]" >  <!--" -->
