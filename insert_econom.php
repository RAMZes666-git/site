            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"> <a href="insert_econom.php">Добавить эконом. хар-ки</a></li>
                        ...
                        <div class="content-panel">
                            <table class="table table-bordered table-striped table-condensed ">
                                ...
                                <tr style="text-align: center">
                                    ...
                                    <td> <input type="text" id="limitation35" autocomplete="off"   size="10"   style="height:34px"  name="p35" ></td>
                                    <td> <input type="text" id="limitation36" autocomplete="off"   size="10"   style="height:34px"  name="p36" ></td>
                                    <td> <input type="text" id="limitation37" autocomplete="off"   size="10"   style="height:34px"  name="p37" ></td>
                                    <td> <input type="text" id="limitation38"  autocomplete="off"   size="10"   style="height:34px"  name="p38" ></td>
                                    <td> <input type="text" id="limitation39" autocomplete="off"   size="10"   style="height:34px"  name="p39" ></td>
                                    <td> <input type="text" id="limitation40" autocomplete="off"   size="10"   style="height:34px"  name="p40" ></td>
                                    <td> <input type="text" id="limitation41" autocomplete="off"   size="10"   style="height:34px"  name="p41" ></td>
                                        </select> </td>
                                </tr>
                                <tr style="text-align: center">
                                    <td>
                                    ...
                                    <td> <input id=""  class="btn btn-theme"  type="submit" value="Обновить страницу" onclick="Click()" >
                                        <?php include 'insert_economCode.php';
                                        ?>
                                    </td>
                                <tr>
                                </tr>
...
<script>
    ...
    perem35 = document.getElementById("limitation35");
    perem36 = document.getElementById("limitation36");
    perem37 = document.getElementById("limitation37");
    perem38 = document.getElementById("limitation38");
    perem39 = document.getElementById("limitation39");
    perem40 = document.getElementById("limitation40");
    perem41 = document.getElementById("limitation41");
    ...
    perem35.oninput = perem35.onkeydown = inputFloat;
    perem36.oninput = perem36.onkeydown = inputFloat;
    perem37.oninput = perem37.onkeydown = inputFloat;
    perem38.oninput = perem38.onkeydown = inputFloat;
    perem39.oninput = perem39.onkeydown = inputFloat;
    perem40.oninput = perem40.onkeydown = inputFloat;
    perem41.oninput = perem41.onkeydown = inputFloat;
