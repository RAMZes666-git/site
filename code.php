...
$Count1= $_REQUEST['capital'];
if( empty($Count1) ){
    $Count1=4;
} else $Count1= $_REQUEST['capital'];
/*
$info = array() ;
...
for ($i = 0; $i <$Count1 ; $i++) {
  ...
  // $smeschenie_osi_Y = min(0, $Profit + $smeschenie_osi_Y);
...
$massiv=array();
$massiv1=array();
/*for($i=0; $i< count($mass);$i+=10){
   array_push($massiv, $mass[$i]);
}
for($i=0; $i< count($mass1);$i+=10){
    array_push($massiv1, $mass1[$i]);
}*/
