            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"> <a href="form_input.php">Добавить машину</a></li>
                        ...
                        <div class="content-panel">
                            ...
                            <table class="table table-bordered table-striped table-condensed ">
                                ...
                                <tr>
                                    ...
                                    <td width=200px>
                                        <select name="tip" id="" class="form-control" style="width: 100% "  >
                                            <option selected disabled>выберите тип машины</option>
                                            <?php
                                    ...
                                    <td>
                                        <input type="text" autocomplete="off" id="textInput"   size="10"   style="height:34px; width: 50%"  name="id_tip" >

                                    <input id="clearButton"  class="btn btn-theme"  type="submit" value="Добавить" >
                                    <input id=""  class="btn btn-theme"  type="submit" value="Обновить страницу" onclick="Click()" >

                                    <?php  include 'input_machine.php';
