...
$Count1= $_REQUEST['member1'];


//array_push($H_finish,$Count2,$Count3,$Count4);

if($Count1==1){
    $Count2= $_REQUEST['keks0'];
    $H_finish=array($Count2);

}
if($Count1==2){
    $Count2= $_REQUEST['keks0'];
    $Count3= $_REQUEST['keks1'];
  ///  array_push($H_finish,$Count2,$Count3,0,0);
    $H_finish=array($Count2,$Count3);
}
if($Count1==3){
    $Count2= $_REQUEST['keks0'];
    $Count3= $_REQUEST['keks1'];
    $Count4= $_REQUEST['keks2'];
   // array_push($H_finish,$Count2,$Count3,$Count4,0);

    $H_finish=array($Count2,$Count3,$Count4);
}
if($Count1==4){
    $Count2= $_REQUEST['keks0'];
    $Count3= $_REQUEST['keks1'];
    $Count4= $_REQUEST['keks2'];
    $Count5= $_REQUEST['keks3'];
    ///array_push($H_finish,$Count2,$Count3,$Count4,$Count5);
    $H_finish=array($Count2,$Count3,$Count4,$Count5);
}
///else array_push($H_finish,5500,4500,3500,3000);



/*
if( empty($Count2 or $Count3 or $Count4 or $Count5)){
    $H_finish=array(5500,4500,3500,3000);
}else array_push($H_finish,$Count2,$Count3,$Count4,$Count5);
*/
...
echo 'П на 1 мтч ' . (($Global_Profit - $array_1[0]['стоим_КР']) / ($Hglobal + $H+1)) . ' руб/моточас ' . '</br>';
